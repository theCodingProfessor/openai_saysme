...
def chat_get():
    # gpt-3.5-turbo is completion = openai.ChatCompletion.create(model="gpt-3.5-turbo",
    #    messages=[ {"role": "user", "content": "Hello!"} ]
    # using python what is the syntax to catch a response generated by a call to openai.Embedding.create
    ...
    # return_response = pprint.pprint(completion)
